...
export const STANDBEINE: StandbeinConfig[] = [
  {
    id: "wärmepumpen-austausch",
    label: "Wärmepumpen-Austausch",
    kicker: "Bestand modernisieren",
    description: "Bestehende Anlage ersetzen und den passenden Wärmepumpenpfad gemeinsam vorbereiten.",
    hint: "Ideal, wenn bereits ein Heizsystem vorhanden ist und du auf eine neue Wärmepumpe umsteigen möchtest.",
    category: "heating",
  ...
  },
  {
    ...
    description: "Direktverdampfer gezielt ersetzen und die relevanten Rahmenbedingungen früh abklären.",
    hint: "Mit eigenem Ablauf für bestehende Direktverdampfer-Systeme.",
    category: "heating",
  ...
  },
  {
    ...
    description: "Von bestehender Heizung auf ein neues System wechseln und die passende Wärmequelle eingrenzen.",
    hint: "Geeignet für Öl-, Gas- oder andere Bestandsheizungen mit offenem Zielsystem.",
    category: "heating",
    stepIds: ["heating-system-profile", "heating-existing-system", "heating-source-air", "heating-source-geo", "heating-source-water"],
  },
  {
    ...
    description: "Bedarfe im Neubau bündeln und daraus die passenden Teilpfade für Energie und Haustechnik ableiten.",
    hint: "Mehrere Bedarfe können kombiniert werden, ohne dass der Ablauf unübersichtlich wird.",
    category: "hybrid",
  ...
  },
  {
    ...
    description: "Vorhandene PV-Anlage erweitern, Speicher nachrüsten oder neue Verbraucher besser einbinden.",
    hint: "Mit eigener Strecke für Bestand und Erweiterungsziele.",
    category: "pv",
...
export const STEP_CONFIG: StepConfig[] = [
  {
    ...
    shortTitle: "Einstieg",
    description: "Wähle den passenden Projektpfad für dein Vorhaben.",
  ...
  },
  {
    ...
    shortTitle: "Objekt",
    description: "Die Basis zum Gebäude oder Projekt, damit wir die Situation richtig einschätzen.",
  ...
  },
  {
    ...
    shortTitle: "System",
    description: "Welche Richtung du anstrebst und wie Wärme und Warmwasser im Alltag gedacht werden.",
  ...
  },
  {
    ...
    title: "Luftwärme-Pfad",
    shortTitle: "Luft",
    description: "Nur die Fragen, die für einen Luftwärme-Pfad relevant sind.",
  ...
  },
  {
    ...
    title: "Erdwärme-Pfad",
    shortTitle: "Erdwärme",
    description: "Rahmenbedingungen für Erdwärme, Kollektor oder Tiefenbohrung.",
    fieldIds: ["geothermalDrillingChoice", "geothermalArea"],
    visibleWhen: (values) => isHeatingSourceSelected(values, "erdwärme"),
  },
  {
    id: "heating-source-water",
    title: "Grundwasser-Pfad",
    shortTitle: "Grundwasser",
    description: "Eigener Zweig für Grundwasser mit Brunnen- und Genehmigungs-Check.",
  ...
  },
  {
    ...
    description: "Bestehendes System, Zielbild und die wichtigsten Punkte für den Austausch.",
  ...
  },
  {
    ...
    shortTitle: "Standort",
    description: "Platz, Garten und mögliche nächste Richtung im Direktverdampfer-Kontext.",
  ...
  {
    id: "newbuild-heating",
    title: "Wärmeversorgung im Neubau",
    shortTitle: "Wärme",
    description: "Nur sichtbar, wenn im Neubau ein Wärmethema mitgedacht wird.",
    fieldIds: ["newBuildHeatingSource", "newBuildHeatDistribution", "heatingWarmWater"],
    visibleWhen: (values) => hasNewBuildNeed(values, "wärmepumpe"),
  },
  {
    id: "newbuild-pv",
    title: "PV, Speicher & E-Mobilität",
    shortTitle: "Energie",
  ...
  },
  {
    ...
    title: "PV-Grundlagen",
    shortTitle: "PV-Basis",
    description: "Dach, Verbrauch und Verschattung als Ausgangspunkt für eine neue Anlage.",
  ...
  },
  {
    ...
    shortTitle: "Optionen",
    description: "Speicher, Wallbox und künftige Verbraucher für die passende Auslegung.",
  ...
  },
  {
    ...
    shortTitle: "Ziele",
    description: "Was dir im Projekt besonders wichtig ist und welche Richtung Vorrang hat.",
    fieldIds: ["projectGoals"],
  },
  {
    id: "uebergabe",
    title: "Kontakt & Übergabe",
    shortTitle: "Übergabe",
    description: "Deine Kontaktdaten, Budget, Zeitrahmen und wie wir dich am besten begleiten dürfen.",
...
export const FIELD_CONFIG: FieldConfig[] = [
  {
    id: "projectStandbein",
    stepId: "einstieg",
    label: "Womit dürfen wir dich begleiten?",
    kind: "choice-single",
    description: "Dein Standbein bestimmt den gesamten weiteren Ablauf. Danach siehst du nur noch die wirklich passenden Fragen.",
    required: true,
  ...
  },
  {
    id: "heatedArea",
    stepId: "objekt",
    label: "Wie gross ist die relevante Fläche ungefähr?",
    kind: "number",
    unit: "m2",
    min: 20,
    max: 2500,
  ...
  },
  {
    ...
    kind: "choice-single",
    required: true,
    helperText: "Diese Angabe hilft uns bei der Einschätzung des heutigen Niveaus.",
    helperCtaLabel: "Wie kann ich das abschätzen?",
    helperTitle: "Orientierung für den Sanierungszustand",
    helperBody: "Du musst das nicht technisch exakt beantworten. Eine ehrliche Einschätzung reicht.",
    helperItems: [
  ...
  },
  {
    id: "ownershipStatus",
    stepId: "objekt",
    label: "Wie ist deine Situation beim Objekt?",
    kind: "choice-single",
    required: true,
    options: [
  ...
  },
  {
    ...
    label: "Welche Lösung soll im Fokus stehen?",
    kind: "choice-single",
    description: "Damit wir den passenden Unterpfad für Luftwärme, Erdwärme oder Grundwasser öffnen können.",
    required: true,
    options: [
      { label: "Luftwärmepumpe", value: "luft" },
      { label: "Erdwärme", value: "erdwärme" },
      { label: "Grundwasser", value: "grundwasser" },
      { label: "Noch offen / gemeinsam klären", value: "offen" },
    ],
  },
  {
  ...
  },
  {
    ...
    helperBody: "Eine ungefähre Angabe genügt. Häufig steht das Baujahr auf dem Typenschild der Anlage, in Serviceberichten oder alten Unterlagen.",
  ...
  },
  {
    ...
    helperBody: "Bei bestehenden Wärmepumpen oder Direktverdampfern steht diese Angabe häufig im Displaymenue oder in Serviceunterlagen.",
    visibleWhen: (values) =>
      values.heatingCurrentSystem === "wärmepumpe" || values.heatingCurrentSystem === "direktverdampfer",
  },
  {
  ...
  },
  {
    ...
    label: "Wie viel Platz ist für ein Außengerät vorhanden?",
    kind: "choice-single",
    required: true,
    description:"Uns reicht deine grobe Einschätzung. Im Zweifel prüfen wir das später gemeinsam.",
    options: [
      { label: "genug Platz vorhanden", value: "gut" },
      { label: "eng / nur eingeschränkt möglich", value: "eng" },
      { label: "ich weiss es nicht", value: "unbekannt" },
    ],
  },
  {
    ...
    stepId: "heating-source-air",
    label: "Gibt es beim Aufstellort besondere Rücksicht auf Abstand oder Lautstärke?",
    kind: "choice-single",
    required: true,
    options: [
  ...
  },
  {
    ...
    label: "Welche Erdwärme-Richtung ist denkbar?",
    kind: "choice-single",
    required: true,
    options: [
      { label: "Tiefenbohrung", value: "tiefenbohrung" },
      { label: "Flächenkollektor", value: "kollektor" },
      { label: "noch offen / bitte gemeinsam prüfen", value: "offen" },
    ],
  },
  {
    id: "geothermalArea",
    stepId: "heating-source-geo",
    label: "Wie gross ist die verfügbare Aussenfläche ungefähr?",
    kind: "number",
    unit: "m2",
    min: 50,
    max: 5000,
    description:"Grobe Orientierung für Garten oder Freifläche genügt.",
  },
  {
    id: "groundwaterWell",
  ...
  },
  {
    ...
    options: [
      ...
      { label: "soll geprueft werden", value: "prüfen" },
      { label: "noch offen", value: "offen" },
    ],
  },
  {
    ...
    stepId: "dv-profile",
    label: "Was ist der Hauptgrund für den Austausch?",
    kind: "choice-multi",
  ...
  },
  {
    ...
    stepId: "dv-site",
    label: "Wie groß ist der verfügbare Außenbereich?",
    kind: "choice-single",
    required: true,
    options: [
      { label: "gut zugänglich", value: "gut" },
      { label: "eingeschränkt", value: "eingeschränkt" },
      { label: "noch offen", value: "offen" },
    ],
  },
  {
    ...
    kind: "choice-multi",
    description: "Du kannst mehrere Bedarfe kombinieren. Daraus entstehen die passenden nächsten Teilpfade.",
    required: true,
    options: [
      { label: "Wärmepumpe", value: "wärmepumpe" },
      { label: "Photovoltaik", value: "pv" },
      { label: "Speicher", value: "speicher" },
      { label: "Wallbox / E-Mobilität", value: "wallbox" },
      { label: "kontrollierte Wohnraumlüftung", value: "lüftung" },
  ...
  },
  {
    ...
    label: "Welche Wärmequelle ist im Neubau angedacht?",
    kind: "choice-single",
    required: true,
    options: [
      { label: "Luftwärmepumpe", value: "luft" },
  ...
  },
  {
    ...
    stepId: "newbuild-heating",
    label: "Wie soll die Wärme verteilt werden?",
    kind: "choice-single",
    required: true,
    options: [
      { label: "Fussbodenheizung", value: "fussbodenheizung" },
  ...
  },
  {
    id: "newBuildRoofForm",
    stepId: "newbuild-pv",
    label: "Welche Dachform ist für PV relevant?",
    kind: "choice-single",
    required: true,
    options: [
  ...
  },
  {
    ...
    stepId: "newbuild-pv",
    label: "Wie ist die relevante Dachfläche ausgerichtet?",
    kind: "choice-single",
    required: true,
    options: [
  ...
  },
  {
    id: "newBuildRoofArea",
    stepId: "newbuild-pv",
    label: "Welche nutzbare Dachfläche steht ungefähr zur Verfügung?",
    kind: "number",
    unit: "m2",
    min: 10,
    max: 1000,
  ...
  },
  {
    ...
    stepId: "pv-new-base",
    label: "Wie hoch ist dein Jahresstromverbrauch?",
    kind: "number",
    unit: "kWh",
    required: true,
    min: 1000,
    ...
    helperBody: "Die Kilowattstunden-Zahl steht auf deiner letzten Jahresabrechnung vom Stromversorger. Eine grobe Angabe reicht voellig aus.",
  },
  {
    id: "pvRoofForm",
    stepId: "pv-new-base",
  ...
  },
  {
    ...
    kind: "choice-single",
    required: true,
    helperText: "Wenn du es nicht genau weißt, reicht auch eine gute Schätzung.",
    ...
    helperItems: [
      "Sued: Sonne mittags direkt auf der Fläche",
      "Ost / West: morgens oder abends deutlich mehr Sonne",
      "wenn du unsicher bist, wähle die am ehesten passende Richtung",
    ],
    options: [
      { label: "Sued", value: "sued" },
      { label: "Ost / West", value: "ost-west" },
  ...
  },
  {
    id: "pvRoofArea",
    stepId: "pv-new-base",
    label: "Wie gross ist die nutzbare Dachfläche ungefähr?",
    kind: "number",
    unit: "m2",
    required: true,
    min: 10,
    max: 1000,
    description:"Fotos oder Pläne helfen uns später beim genaueren Blick.",
  },
  {
    id: "pvShading",
    stepId: "pv-new-base",
  ...
  },
  {
    ...
    options: [
      { label: "ja", value: "ja" },
      { label: "nein", value: "nein" },
      { label: "später möglich", value: "später" },
    ],
  },
  {
    id: "pvLargeConsumers",
    stepId: "pv-new-options",
    label: "Welche größeren Verbraucher sind relevant?",
    kind: "choice-multi",
    options: [
      { label: "Wärmepumpe", value: "wärmepumpe" },
  ...
  },
  {
    ...
    stepId: "pv-new-options",
    label: "Gibt es geplante Anschaffungen oder Verbrauchsveränderungen?",
    kind: "textarea",
  ...
  },
  {
    ...
    label: "Wie gross ist die bestehende Anlage ungefähr?",
    kind: "number",
    unit: "kWp",
    required: true,
    min: 1,
  ...
  },
  {
    ...
    stepId: "pv-extension-existing",
    label: "Wie alt ist der bestehende Wechselrichter ungefähr?",
    kind: "number",
    unit: "Jahre",
    min: 0,
    max: 40,
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Speicher nachrüsten", value: "speicher" },
  ...
  },
  {
    id: "projectGoals",
    stepId: "ziele",
    label: "Was ist dir bei diesem Projekt besonders wichtig?",
    kind: "choice-multi",
    description: "Mehrfachauswahl möglich. Wähle einfach die Punkte, die dir am meisten bedeuten.",
    required: true,
    options: [
      { label: "Energiekosten senken", value: "energiekosten-senken" },
      { label: "Komfort verbessern", value: "komfort-verbessern" },
      { label: "Eigenverbrauch erhöhen", value: "eigenverbrauch-erhöhen" },
      ...
      { label: "Förderungen optimal nutzen", value: "förderungen" },
    ],
  },
  {
    id: "fullName",
  ...
  },
  {
    ...
    helperText: "Du kannst die Anfrage auch ohne Upload absenden. Unterlagen helfen nur bei der schnelleren Einschätzung.",
  },
  {
    id: "budgetRange",
    stepId: "uebergabe",
    ...
    kind: "choice-single",
    required: true,
    description: "Auch eine grobe Richtung hilft uns bereits weiter.",
    options: [
  ...
  },
  {
    ...
    kind: "choice-single",
    required: true,
    description: "So können wir die Anfrage zeitlich einordnen und dich passend begleiten.",
    options: [
  ...
  },
  {
    id: "contactRequest",
    stepId: "uebergabe",
    label: "Wie dürfen wir dich am besten kontaktieren?",
    kind: "choice-single",
    required: true,
    description: "So melden wir uns auf dem für dich angenehmsten Weg.",
    options: [
  ...
  },
  {
    id: "finalNotes",
    stepId: "uebergabe",
    label: "Gibt es noch etwas, das wir für den Erstkontakt wissen sollten?",
    kind: "textarea",
    placeholder: "z. B. beste Erreichbarkeit, bereits vorliegende Angebote, Förderungsfrage oder Wunsch nach Vor-Ort-Termin ...",
  },
];
