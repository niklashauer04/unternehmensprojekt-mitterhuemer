...
export const STEP_CONFIG: StepConfig[] = [
  {
    ...
    shortTitle: "Einstieg",
    description: "Waehlen Sie den passenden Projektpfad fuer Ihr Vorhaben.",
  ...
  {
    id: "uebergabe",
    title: "Kontakt & Uebergabe",
    shortTitle: "Uebergabe",
    description: "Deine Kontaktdaten, Budget, Zeitrahmen und wie wir dich am besten begleiten duerfen.",
