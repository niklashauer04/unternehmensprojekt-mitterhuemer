...
export const STANDBEINE: StandbeinConfig[] = [
  {
    ...
    hint: "Ideal, wenn bereits ein Heizsystem vorhanden ist und Sie auf eine neue Wärmepumpe umsteigen möchten.",
    category: "heating",
  ...
  },
  {
    ...
    description: "Direktverdampfer gezielt ersetzen und die relevanten Rahmenbedingungen frueh abklären.",
  ...
  },
  {
    ...
    hint: "Geeignet für Oel-, Gas- oder andere Bestandsheizungen mit offenem Zielsystem.",
    category: "heating",
    stepIds: ["heating-system-profile", "heating-existing-system", "heating-source-air", "heating-source-geo", "heating-source-water"],
  },
  {
...
export const STEP_CONFIG: StepConfig[] = [
  {
    ...
    shortTitle: "Einstieg",
    description: "Wählen Sie den passenden Projektpfad für Ihr Vorhaben.",
  ...
  },
  {
    ...
    shortTitle: "System",
    description: "Welche Richtung Sie anstreben und wie Wärme und Warmwasser im Alltag gedacht werden.",
  ...
  },
  {
    ...
    shortTitle: "Optionen",
    description: "Speicher, Wallbox und kuenftige Verbraucher für die passende Auslegung.",
...
export const FIELD_CONFIG: FieldConfig[] = [
  {
    id: "projectStandbein",
    stepId: "einstieg",
    label: "Womit dürfen wir Sie begleiten?",
    kind: "choice-single",
  ...
  },
  {
    ...
    helperBody: "Sie müssen das nicht technisch exakt beantworten. Eine ehrliche Einschätzung reicht.",
    helperItems: [
      "unsaniert: aeltere Fenster, wenig Dämmung, kaum thermische Verbesserungen",
      ...
      "Neubau-Standard: modernes, gut gedaemmtes Gebäude",
    ],
    options: [
  ...
  },
  {
    ...
    kind: "choice-single",
    description: "Damit wir den passenden Unterpfad für Luftwärme, Erdwärme oder Grundwasser oeffnen können.",
    required: true,
    options: [
  ...
  },
  {
    ...
    helperBody: "Eine ungefähre Angabe genügt. Haeufig steht das Baujahr auf dem Typenschild der Anlage, in Serviceberichten oder alten Unterlagen.",
  ...
  },
  {
    ...
    helperBody: "Bei bestehenden Wärmepumpen oder Direktverdampfern steht diese Angabe haeufig im Displaymenue oder in Serviceunterlagen.",
    visibleWhen: (values) =>
  ...
  },
  {
    ...
    label: "Wie schaetzen Sie die Platzverhaeltnisse für ein Aussengeraet ein?",
    kind: "choice-single",
    required: true,
    description:"Uns reicht Ihre grobe Einschätzung. Im Zweifel pruefen wir das später gemeinsam.",
    options: [
      { label: "genug Platz vorhanden", value: "gut" },
      { label: "eng / nur eingeschraenkt möglich", value: "eng" },
      { label: "ich weiss es nicht", value: "unbekannt" },
    ],
  },
  {
  ...
  },
  {
    id: "geothermalArea",
    stepId: "heating-source-geo",
    label: "Wie gross ist die verfuegbare Aussenfläche ungefähr?",
    kind: "number",
    unit: "m2",
    min: 50,
    max: 5000,
  ...
  },
  {
    ...
    kind: "choice-multi",
    description: "Sie können mehrere Bedarfe kombinieren. Daraus entstehen die passenden nächsten Teilpfade.",
    required: true,
    options: [
      { label: "Wärmepumpe", value: "wärmepumpe" },
  ...
  },
  {
    ...
    kind: "choice-multi",
    description: "Mehrfachauswahl möglich. Wählen Sie einfach die Punkte, die aktuell den groessten Unterschied machen.",
    required: true,
    options: [
  ...
  },
  {
    ...
    helperText: "Sie können die Anfrage auch ohne Upload absenden. Unterlagen helfen nur bei der schnelleren Einschätzung.",
  },
  {
    id: "budgetRange",
    stepId: "uebergabe",
  ...
  },
  {
    ...
    kind: "choice-single",
    required: true,
    description:"Damit wir die Anfrage zeitlich richtig einordnen und passend begleiten können.",
    options: [
  ...
  },
  {
    id: "contactRequest",
    stepId: "uebergabe",
    label: "Wie dürfen wir Sie am besten weiter begleiten?",
    kind: "choice-single",
    required: true,
    description:"So melden wir uns in der Form, die für Sie am angenehmsten ist.",
    options: [
